...
std::string CamVector::applyTool(std::string toolName,std::string label,std::string option) {
...
std::string CamVector::applyService(std::string toolName,std::string label,std::string option) {
