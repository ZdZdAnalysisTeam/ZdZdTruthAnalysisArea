...
std::string CamDeque::applyTool(std::string toolName,std::string label,std::string option) {
...
std::string CamDeque::applyService(std::string toolName,std::string label,std::string option) {
