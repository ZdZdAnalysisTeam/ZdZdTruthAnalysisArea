...
StatusCode CamWriter::apply(CamObject* object, std::string& label, std::string option) {
   ...
   //decide if we should keep the TLV or not
      ...
      boost::unordered_map<std::string,boost::any>* propMap = object->getPropertyMap();
      for(boost::unordered_map<std::string,boost::any>::iterator prop = propMap->begin();prop!=propMap->end();++prop) {
...
StatusCode CamWriter::apply(CamDeque* deque, std::string& label, std::string option) {
   ...
   for(CamObject* obj : *deque) {
      ...
      boost::unordered_map<std::string,boost::any>* propMap = obj->getPropertyMap();
      boost::unordered_map<std::string,boost::any>::iterator prop = propMap->begin();
      boost::unordered_map<std::string,boost::any>::iterator propEnd = propMap->end();
...
StatusCode CamWriter::apply(CamEvent* event, std::string& label, std::string option) {
...
std::vector<bool>& CamWriter::getTLVFormatVec(std::string& label, std::string& option) {
