...
class CamWriter : virtual public CamService, virtual public IIncidentListener {
  ...
  public:
      ...
      virtual StatusCode apply(CamObject* object,std::string& label, std::string option);
      virtual StatusCode apply(CamDeque* deque,std::string& label, std::string option);
      virtual StatusCode apply(CamEvent* event,std::string& label, std::string option);
   ...
   private:
      ...
      std::vector<bool>& getTLVFormatVec(std::string& label, std::string& option);
