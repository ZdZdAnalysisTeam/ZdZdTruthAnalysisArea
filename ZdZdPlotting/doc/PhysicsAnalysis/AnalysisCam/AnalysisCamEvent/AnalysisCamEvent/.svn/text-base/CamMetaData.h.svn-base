...
class CamMetaData : virtual public CamTool {
  ...
  public:
      ...
      virtual StatusCode apply(CamEvent* event,std::string& label, std::string option) { return apply(dynamic_cast<CamObject*>(event),label,option);}
      virtual StatusCode apply(CamObject* event,std::string& label, std::string option);
